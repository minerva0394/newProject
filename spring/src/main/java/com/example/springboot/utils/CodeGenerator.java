...
public class CodeGenerator {
    ...
    private static void generate() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/newProject?serverTimezone=GMT%2b8", "root", "zzlde500")
                .globalConfig(builder -> {
                    builder.author("zengzl") // 设置作者
                            .enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("/Users/zengzl/Desktop/newProject/spring/src/main/java"); // 指定输出目录
                })
