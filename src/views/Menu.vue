    ...
    <el-dialog title="菜单信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form label-width="80px" size="large">
        ...
        <el-form-item label="页面路径">
          <el-input v-model="form.pagePath" autocomplete="off" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exp() {
      //todo 发布记得换
      window.open("http://43.139.122.43:9091/menu/export")
      // window.open("http://localhost:9091/menu/export")
    },
    handleImportSuccess() {
